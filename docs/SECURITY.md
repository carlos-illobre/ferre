...
| Acceso al mostrador sin usuario | Login con Google (sin contraseñas), sesiones opacas revocables, roles dueño/admin/mostrador (el admin administra pero no toca dueños), límite de intentos ([ADR-011](adr/ADR-011-autenticacion-sin-contrasenas.md)) | Hecho (#41) |
